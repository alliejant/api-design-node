	...
	function m(_) {
		...
		function Wr(n, t) {
			...
			return ("string" == r && dn.test(n)) || "number" == r
				? true
				: Oo(n) ? false : !yn.test(n) || (null != t && n in Br(t));
		}
		function $r(n) {
			var t = br(n),
				r = Nn[t];
			return typeof r == "function" && t in zn.prototype
				? n === r ? true : ((t = zu(r)), !!t && n === t[0])
				: false;
		}
		function Sr(n) {
		...
		function ye(n) {
			return null == n
				? false
				: ve(n) ? uu.test(Qe.call(n)) : h(n) && Rn.test(n);
		}
		function de(n) {
